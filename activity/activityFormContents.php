 ...
 <div class="radio" id="doYouPerformAdult">
  <fieldset>
   <legend><span>Do you perform this procedure?</span></legend>
	<input type="radio" name="isPerformedAdult" id="isPerformedAdultYes" value="yes"   <?php if($isPerformedAdult=="yes") echo 'checked="checked"';  ?>  /><label for="isPerformedAdultYes">Yes</label>
	<input type="radio" name="isPerformedAdult" id="isPerformedAdultNo" value="no" <?php if($isPerformedAdult=="no") echo 'checked="checked"';   ?> /><label for="isPerformedAdultNo">No</label>
 ...
 <div class="radio startHidden" id="timeStandardAdult">
  <fieldset>
   <legend><span>Do you have a time standard for this?</span></legend>
	<input type="radio" name="hasTimestandardAdult" id="hasTimestandardAdultYes" value="yes"   <?php if($hasTimestandardAdult=="yes") echo 'checked="checked"';  ?> /><label for="hasTimestandardAdultYes">Yes</label> 
	<input type="radio" name="hasTimestandardAdult" id="hasTimestandardAdultNo" value="no"    <?php if($hasTimestandardAdult=="no") echo 'checked="checked"';   ?> /><label for="hasTimestandardAdultNo">No</label>
...
<fieldset class="inputBox">
 <legend><span>For Pediatrics</span></legend>
  <div class="radio" id="doYouPerformPediatric">
   <fieldset> 
	<legend><span>Do you perform this procedure?</span></legend>
	<input type="radio" name="isPerformedPediatric" id="isPerformedPediatricYes" value="yes" <?php if($isPerformedPediatric=="yes") echo 'checked="checked"'; ?> /><label for="isPerformedPediatricYes" >Yes</label> 
	<input type="radio" name="isPerformedPediatric" id="isPerformedPediatricNo" value="no" <?php if($isPerformedPediatric=="no") echo 'checked="checked"';   ?> /><label for="isPerformedPediatricNo">No</label>
  ...
  <div class="radio startHidden" id="timeStandardPediatric">
   <fieldset>
	<legend><span>Do you have a time standard for this?</span></legend>
	<input type="radio" name="hasTimestandardPediatric" id="hasTimestandardPediatricYes" value="yes"   <?php if($hasTimestandardPediatric=="yes") echo 'checked="checked"';  ?> />  <label for="hasTimestandardPediatricYes" >Yes</label>
	<input type="radio" name="hasTimestandardPediatric" id="hasTimestandardPediatricNo" value="no"    <?php if($hasTimestandardPediatric=="no") echo 'checked="checked"';   ?> />  <label for="hasTimestandardPediatricNo" >No</label>
...
<fieldset class="inputBox">
 <legend><span>For Neonatal:</span></legend>
  <div class="radio" id="doYouPerformNatal">
	<fieldset>
	 <legend><span>Do you perform this procedure?</span></legend>
	  <input type="radio" name="isPerformedNatal" id="isPerformedNatalYes" value="yes"   <?php if($isPerformedNatal=="yes") echo 'checked="checked"';  ?> /><label for="isPerformedNatalYes">Yes</label>
	  <input type="radio" name="isPerformedNatal" id="isPerformedNatalNo"  value="no" <?php if($isPerformedNatal=="no") echo 'checked="checked"';    ?> /><label for="isPerformedNatalNo">No</label>
  ...
  <div class="radio startHidden" id="timeStandardNatal">
    <fieldset>
     <legend><span>Do you have a time standard for this?</span></legend>
	  <input type="radio" name="hasTimestandardNatal" id="hasTimestandardNatal1" value="yes"   <?php if($hasTimestandardNatal=="yes") echo 'checked="checked"';  ?> /><label for="hasTimestandardNatal1">Yes</label>
	  <input type="radio" name="hasTimestandardNatal" id="hasTimestandardNatal2" value="no"    <?php if($hasTimestandardNatal=="no") echo 'checked="checked"';   ?> /><label for="hasTimestandardNatal2">No</label>
